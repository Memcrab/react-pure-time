...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if(true)
			module.exports = factory(__webpack_require__(84));
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var localTimezoneOffset = new Date().getTimezoneOffset() * 60 * 1000;
		...
		var Time = function (_Component) {
		  ...
		  _createClass(Time, [{
		    ...
		    value: function normalizeValue(value) {
		      var milliseconds = new RegExp(/^[0-9]{0,13}$/);
		      switch (true) {
		        case milliseconds.test(value):
		    ...
		    value: function render() {
		      ...
		      var ifEmpty = _props.ifEmpty;
		      var className = _props.className;

		      return _react2.default.createElement(
		        'span',
		        { className: className },
		        value ? (0, _format2.default)(this.normalizeValue(value), format) : ifEmpty
		      );
		    }
		  }]);
		...
		Time.propTypes = {
		  ...
		  value: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number, _react.PropTypes.instanceOf(Date)]),
		  ifEmpty: _react.PropTypes.string,
		...
		function date(timestamp, format) {
		  ...
		  f = {
		    ...
		    W: function W() {
		      ...
		      var b = new Date(a.getUTCFullYear(), 0, 4);
